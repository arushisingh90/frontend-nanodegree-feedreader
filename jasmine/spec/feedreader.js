    ...
    */
    describe('RSS Feeds', function() {
         ...
         */
         ...
         it('have URLs defined and they are not empty', function(){
         ...
         */
         ...
         it('have names defined and they are not empty', function(){
            for(i = 0; i < allFeeds.length; i++){
    ...
    /* Test suite "Initial Entries" */
     describe('Initial Entries',function(){
         ...
         */
         it('load is working and has altlest one .entry element in .feed container',function(done){
